...
import { Mail, Phone, MapPin, CodeXml } from "lucide-react";
...
const Home = () => {
  ...
  return (
    <div className="bg-[#f8fafc] dark:bg-[#121212] text-gray-800 dark:text-gray-200">
      <section className="min-h-screen flex items-center pt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 fade-in">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 dark:text-gray-200 mb-4">
                {t("greeting")}{" "}
                <span className="text-blue-600 dark:text-orange-400">
                  {t("name")}
                </span>
              </h1>
              <h2 className="text-2xl md:text-3xl text-gray-600 dark:text-gray-200 mb-6">
                {t("title")}
              </h2>
              <p className="text-gray-600 dark:text-gray-200 mb-8 max-w-lg">
                {t("description")}
              </p>
              <div className="flex space-x-4">
                <a
                  href="#contact"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition duration-300 transform hover:scale-105 dark:bg-[#2563eb]"
                >
                  {t("buttons.contact")}
                </a>
                <a
      ...
      <section className="pt-10">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-6 text-center tracking-wide">
          {t("social.title")}
        </h2>
        <Network />
      </section>
        ...
        <div className="container mx-auto space-y-6 px-6 lg:px-4 py-4 ">
          <div className="flex items-start">
            ...
            <div>
              ...
              <a
                href="mailto:hoainamsmurf@gmail.com"
